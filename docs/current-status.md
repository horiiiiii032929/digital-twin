...
| Large factual QA | Refine / v3 no-model implementation | Corrected accounting covers all 2,637 vault files and 2,497 unique hashes; all 610 canonical pending sources match their frozen hashes and 586 (96.1%) pass local conversion probes | Remediate 24 OCR/office/unsupported/empty/parser-invalid sources, assign semantic roles, and pass response-contract, citation, mutation, and audit-packet gates before a bounded pilot |

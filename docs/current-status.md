...
| Large factual QA | Refine / semantic role review | All 2,637 vault files are resolved; 598 use direct local adapters, four scanned PDFs passed Apple Vision OCR, two empty files and one fully redundant archive were excluded; conversion gate passed | Classify 602 readable sources as authoritative/supporting/inspiration/excluded, then pass response-contract, citation, mutation, and audit-packet gates before a bounded pilot |

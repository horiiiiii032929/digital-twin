...
| Generator and prompt | Refine current V4 Pro/P3 candidate; historical V4 Flash selection preserved | V4 Pro/P2 completed the unchanged 48-case public-synthetic development run at one exact fingerprint: original 46/48, corrected diagnosis 47/48 with one real ambiguity failure; Qwen is rejected for citation clearance; deterministic fallback remains | P3 full development result, calibrated semantic citation review, and any prospective profile replacement |
...
1. Run the frozen V4 Pro/P3 public-synthetic development candidate. Require
   48/48 deterministic all-check passes with the same exact provider binding
   and no scenario regression; no generator held-out is authorized.

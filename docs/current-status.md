...
| Large factual QA | Refine / review-policy decision | Conversion passed; no-model semantic triage yields 32 authoritative, 253 supporting, 179 newly excluded, and 138 unresolved assessment/unassigned sources | Select conservative exclusion or authorize sensitivity-tested model-assisted review; then pass response-contract, citation, mutation, and audit-packet gates before a bounded pilot |

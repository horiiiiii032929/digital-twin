...
| Visual representation | Full vault inventoried: 292 clear candidates, 435 review items, 1,909 exclusions; public instrument validated; private 40-case draft structurally valid but unverified | Pending researcher review | Verify every private case in #60, seal the split/ledger, then compare offline V0-V2 pipelines before conditionally running visual embeddings |

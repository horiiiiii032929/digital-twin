...
| Visual representation | Full vault inventoried; private 40-case draft received complete Claude second review and Codex taxonomy adjudication; final researcher review is complete at 40/40 verified after four corrections and one query rewrite | Pending replacement cases and seal | Author seven genuinely visual replacements for text-sufficient candidates, freeze the split/access ledger, then seal and compare offline V0-V2 before conditionally running visual embeddings |

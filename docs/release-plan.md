...
| Factual quality | The actual T0 product must retrieve and answer without receiving gold answers, claims, evidence, or citations | AFQC-044 resolves the failed provider-construction loop with a provider-free deterministic package: 500 public development cases, separate hidden gold, 400 answerable/100 boundary composition, a fixed 100-case control, exact source-range lineage, and zero duplicates or answer leakage. Direct OpenAI/Mistral contracts are tested but unauthorized. No T0 product result exists yet; the sealed 10,000-case run remains unauthorized | [#127](https://github.com/horiiiiii032929/digital-twin/issues/127), with [#110](https://github.com/horiiiiii032929/digital-twin/issues/110) preserved as engineering history |

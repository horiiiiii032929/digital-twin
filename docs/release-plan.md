...
| Proactive tutoring | The published Digital Twin can initiate useful private check-ins without violating consent, quiet hours, frequency, course scope, grounding, withdrawal, or duplicate-delivery rules | A0 in-app baseline retained; A1 development passed and now runs shadow-only after successful new-release publication, with rollback exclusion and redacted non-blocking failure audit; the 12-cluster/60-case confirmation is built but unauthorized, and A1 delivery remains disabled | [#134](https://github.com/horiiiiii032929/digital-twin/issues/134) |

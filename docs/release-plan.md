...
| Factual quality | The actual T0 product must retrieve and answer without receiving gold answers, claims, evidence, or citations | AFQC-058 preserves the valid wording-stage Refine. AFQC-059/060 freeze its 452 accepted variants plus 48 canonical fallbacks and a product-only 500+100 checkpoint. AFQC-061 keeps every quality gate under the USD 8 mini/nano/bounded-full cascade. Attempt 001 stopped before provider I/O on a missing locked retrieval extra; AFQC-063 permits one harness-only corrective attempt. The sealed 10,000 cases remain closed | [#127](https://github.com/horiiiiii032929/digital-twin/issues/127), with [#110](https://github.com/horiiiiii032929/digital-twin/issues/110) preserved as engineering history |
...
| --- | --- | --- |
| Authorize checkpoint 005's 500-case candidate plus 100-case control | Researcher | One actual-product development result using the immutable 452-model/48-canonical package and no new wording calls |
| Authorize the sealed 10,000-case run | Researcher only after checkpoint 005 passes | Professor-reportable actual-product final result |

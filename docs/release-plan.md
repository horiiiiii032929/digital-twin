...
| Factual quality | The actual T0 product must retrieve and answer without receiving gold answers, claims, evidence, or citations | Checkpoints 006/007 are terminal invalid evidence. AFQC-078 built a fresh source-disjoint reference-question gate; validation 001 stopped operationally after seven calls because provider schema and the local question-format invariant diverged. Authority is revoked and no valid product-quality result exists yet | [#127](https://github.com/horiiiiii032929/digital-twin/issues/127) owns the decision on one prospective schema-aligned reference-validation attempt and the later fresh 500+100 confirmation; [#139](https://github.com/horiiiiii032929/digital-twin/issues/139) is Done / Keep and [#110](https://github.com/horiiiiii032929/digital-twin/issues/110) remains engineering history |

...
| Factual quality | The actual T0 product must retrieve and answer without receiving gold answers, claims, evidence, or citations | Checkpoints 006/007 are terminal invalid evidence. Validation 001 stopped operationally after seven calls because provider schema and the local question-format invariant diverged. AFQC-081 builds one schema-aligned attempt 002 with fresh outputs; its focused tests and network-free selection pass, but paid execution remains unauthorized and no valid product-quality result exists yet | [#127](https://github.com/horiiiiii032929/digital-twin/issues/127) owns separate authorization of reference validation 002 and, only after a pass, a fresh 500+100 confirmation; [#139](https://github.com/horiiiiii032929/digital-twin/issues/139) is Done / Keep and [#110](https://github.com/horiiiiii032929/digital-twin/issues/110) remains engineering history |

...
| Proactive tutoring | The published Digital Twin can initiate useful private check-ins without violating consent, quiet hours, frequency, course scope, grounding, withdrawal, or duplicate-delivery rules | Build-only in-app vertical slice implemented; Discord remains disabled; synthetic trigger/suppression evaluation and worker selection pending | [#134](https://github.com/horiiiiii032929/digital-twin/issues/134) |

...
| Factual quality | The actual T0 product must retrieve and answer without receiving gold answers, claims, evidence, or citations | AFQC-058 records a valid wording-stage Refine at 452/500 accepted variants. The runner stopped before T0; authority is revoked and the sealed 10,000-case run remains unauthorized | [#127](https://github.com/horiiiiii032929/digital-twin/issues/127), with [#110](https://github.com/horiiiiii032929/digital-twin/issues/110) preserved as engineering history |
...
| --- | --- | --- |
| Select the wording-layer successor after checkpoint 004 Refine | Researcher | A new frozen product-development checkpoint that reuses the immutable 452-model/48-canonical package without new wording calls |
| Authorize the sealed 10,000-case run | Researcher only after checkpoint 004 passes | Professor-reportable actual-product final result |

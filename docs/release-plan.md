...
| Governed full autonomy V2.1 | A durable event-driven tutor may initiate finite, cited actions inside professor policy and student consent without per-message approval | PR #158 implements release-bound evidence assessment, durable event observation, bounded goal completion, reply/dismiss outcome handling, direct OpenAI planner/generator wiring, professor individual-goal cancellation and outcome audit, and student consent/snooze/resume controls. Local Compose remains on deterministic generation plus qualified T1-v1 by default. A fail-closed configuration guard requires a distinct V2.1 confirmation record before the governed graph can be selected. These additions are product-complete candidates but remain unevaluated and unselected; T1-v1/T0 remain control and rollback | [#153](https://github.com/horiiiiii032929/digital-twin/issues/153), [#155](https://github.com/horiiiiii032929/digital-twin/issues/155), [#156](https://github.com/horiiiiii032929/digital-twin/issues/156), [#157](https://github.com/horiiiiii032929/digital-twin/issues/157) |

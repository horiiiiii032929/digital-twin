...
| Proactive tutoring | The published Digital Twin can initiate useful private check-ins without violating consent, quiet hours, frequency, course scope, grounding, withdrawal, or duplicate-delivery rules | A0 in-app baseline and shadow-by-default A1 evidence-recovery detector implemented; 12/12 P0 and 20/20 P1 synthetic development checks passed with zero side effects or external usage; A1 remains Go Deeper and disabled pending a representative shadow confirmation | [#134](https://github.com/horiiiiii032929/digital-twin/issues/134) |

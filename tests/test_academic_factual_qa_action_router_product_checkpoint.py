...
def test_action_router_checkpoint_is_finite_and_provider_unauthorized() -> None:
    ...
    assert binding["metadata_status"] == "refresh-required"
...
def test_action_router_preflight_fails_closed_before_paid_authorization(
    monkeypatch,
) -> None:

...
Reviewed: 7 September 2026. Slide references match digital-twin-presentation-graduate-final.pptx (32 main slides, Questions, fourteen backup slides). Multiple questions can refer to the same slide.
手元用の短い英語回答。本編で答える論点を含む。実際の教授の発言ではない。

## Slide 04: How much of the system I asked for is actually delivered?
...
## Slide 07: What changes in the system when I change my teaching settings?
...
## Slide 07: Can you show an actual response that reflects the configured teaching approach?
...
## Slide 08: Which parts of the system actually changed between designs?
...
## Slide 11: Why did the more structured system designs perform worse?
...
## Slide 13: Why did you focus on the interface rather than add more ranking?
...
## Slide 14: Why keep BM25 when the final answer score is low? Is your scorer too strict?
...
## Slide 16: What is the actual difference between the four planners?
...
## Slide 16: Why did adding a verifier make the system worse?
...
## Slide 18: Why use the model if rules guard it, and is this utility improvement educationally meaningful?
...
## Slide 18: If the analytic model ranks the actions, why call a language model?
...
## Slide 22: Why not simply send fewer messages or install BKT?
...
## Slide 23: Does the autonomous planner actually use assessed learning progress?
...
## Slide 24: Why not use more flexible generation to improve the incomplete answers?
...
## Slide 25: How did this pass earlier checks, and is the new completion rule a mastery model?
...
## Slide 26: Why did total completions fall? How well did you isolate the fix?
...
## Slide 27: What if consent or publication changes while the model is generating? Why this architecture?
...
## Slide 29: Did the integrated trial demonstrate useful personalized teaching?
...
## Slide 30: Did evaluation leakage inflate your results, and which numbers remain usable?
...
## Slide 31: Why improve the planner input before solving the other quality gaps?
...
## Slide 31: What exactly would you change next, and what result would justify keeping it?
...
## Slide 03 / 32: What is the research contribution?
...
## Slide 18: Is the planner gain meaningful, and what did it cost?
...
## Slide 21: Did BKT win because the simulator behaves like BKT?
...
## Slide 26: Does zero unsupported completion prove the students mastered the objective?

# Course Digital Twin — visual refinement
...
The shaded video cue is not spoken. A timed rehearsal is still needed.
These script files were added after the slide ZIP was created and are separate
from that ZIP. Optional HTML previews depend on the local rendered-slide folder.

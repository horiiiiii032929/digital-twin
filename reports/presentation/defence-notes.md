...
## Slide 02: How much of the system I asked for is actually delivered?
...
## Slide 03: What changes in the system when I change my teaching settings?
...
## Slide 05: Can you show an actual response that reflects the configured teaching approach?
...
## Slide 06: Which parts of the system actually changed between designs?
...
## Slide 07: Why did the more structured system designs perform worse?
...
## Slide 08: Why did you focus on the interface rather than add more ranking?
...
## Slide 09: Why keep BM25 when the final answer score is low? Is your scorer too strict?
...
## Slide 10: What is the actual difference between the four planners?
...
## Slide 11: Why did adding a verifier make the system worse?
...
## Slide 12: Why use the model if rules guard it, and is this utility improvement educationally meaningful?
...
## Slide 13: If the analytic model ranks the actions, why call a language model?
...
## Slide 14: Why did you choose these models, and did every model call succeed?
...
## Slide 15: Why not simply send fewer messages or install BKT?
...
## Slide 16: Does the autonomous planner actually use assessed learning progress?
...
## Slide 17: Why not use more flexible generation to improve the incomplete answers?
...
## Slide 18: How did this pass earlier checks, and is the new completion rule a mastery model?
...
## Slide 19: Why did total completions fall? How well did you isolate the fix?
...
## Slide 20: What if consent or publication changes while the model is generating? Why this architecture?
...
## Slide 21: Did the integrated trial demonstrate useful personalized teaching?
...
## Slide 22: Did evaluation leakage inflate your results, and which numbers remain usable?
...
## Slide 23: Why improve the planner input before solving the other quality gaps?
...
## Slide 24: What exactly would you change next, and what result would justify keeping it?

...
28 main slides, Questions, 8 backup slides. Video: 4:06.

Narration: approximately 4674 words excluding repeated terminology blocks. At 170 words/min plus video: 31.6 minutes before transitions. Rehearse to verify timing.
...
## 2. Delivery against the project brief
...
## 3. Thirty virtual days in the actual software
...
## 5. Instructor settings and observed behavior
...
## 6. System architecture and comparison boundaries
...
## 8. What the simulation executes and supplies
...
## 10. Why the first factual designs rejected questions
...
## 11. Explicit required facts helped; extra ranking did not
...
## 12. Retrieval did not ensure complete answers
...
## 13. Visual retrieval and grounded answers
...
## 14. Planner alternatives and the reject-only failure
...
## 15. Guarded replacement retains the baseline
...
## 16. Learner models and intervention timing
...
## 17. How learner estimation and timing were evaluated
...
## 18. Learner estimation and delivery timing
...
## 19. The default planner still receives a delivery proxy
...
## 20. Structured wording retained critical semantic errors
...
## 21. Completion used evidence from the wrong objective
...
## 22. The correction fixed completion scope
...
## 23. Authority is checked when saving a turn
...
## 24. A retry recognizes the saved in-app delivery
...
## 25. The integrated trial ran, but support stayed generic
...
## 26. Evaluation corrections limit the surviving claims
...
## 27. Next comparison: the planner-input adapter
...
## 28. Deliverable, findings and acceptance gaps
...
## 31. Domain model and persistence
...
## 32. Publication and approval sequence
...
## 33. Reject-only verification path
...
## 34. Full estimator and timing comparison
...
## 35. Planner confirmation and model allocation
...
## 36. Evidence index: studies and decisions
...
## 37. Evidence index: corrections and demonstration

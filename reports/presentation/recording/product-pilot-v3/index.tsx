...
const shots=[
 ...
 {file:'reply.mp4',start:5.4,duration:6,caption:'The cited course explanation identifies x = 1 and the stale-copy update.',day:'VIRTUAL DAY 4 · Source-grounded reply'},
 {file:'follow-up.mp4',start:1.4,duration:4,caption:'The student checks their interpretation of the same example.',day:'VIRTUAL DAY 4 · Follow-up question'},
 {file:'follow-up.mp4',start:5.4,duration:7,caption:'The tutor cites the same evidence again; direct confirmation is still limited.',day:'VIRTUAL DAY 4 · Second reply'},
];
...
function camera(i:number,t:number){
 ...
 if(i===5){const q=ease(t,0,.45);return [1.6,-570,-80-470*q];}
 if(i===6){const q=ease(t,0,.35);return [1.6,-570,-550-70*q];}
...
function Cursor({i,t}:{i:number,t:number}){
 ...
 if(i===5&&t>2.8&&t<3.8){const q=ease(t,2.8,3.2);x=1060+237*q;y=786+43*q;opacity=1;click=3.35;}
...
registerRoot(()=> <Composition id="ProductPilot" component={Demo} durationInFrames={942} fps={30} width={1920} height={1080}/>);

    ...
    def factory(case, clock):
        ...
        def open_app(repository):
            ...
            app = create_app(
                ...
                experimental_final_audit_model_id=experimental_final_audit_model_id,
                post_report_learning_mode=post_report_learning_mode,
                post_report_planner_mode=post_report_planner_mode,
                post_report_goal_recovery_enabled=post_report_goal_recovery_enabled,
                post_report_source_assessment_enabled=post_report_source_assessment_enabled,
                post_report_model_assessment_enabled=post_report_model_assessment_enabled,
                post_report_model_assessment_version=post_report_model_assessment_version,
                post_report_context_retrieval_enabled=post_report_context_retrieval_enabled,
                instructional_contract_repair_enabled=instructional_contract_repair_enabled,
                instructional_final_audit_enabled=instructional_final_audit_enabled,
                instructional_source_state_context_enabled=instructional_source_state_context_enabled,

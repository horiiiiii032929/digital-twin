#!/usr/bin/env python3
"""Bind the diagnosable actual-product autonomy successor 006."""
...
INSTRUMENT_ID = "governed-full-autonomy-v2-1-actual-product-evaluation-006"
INSTRUMENT = ROOT / (
    "research/05_evaluation/instruments/"
    "governed_full_autonomy_v2_1_actual_product_evaluation_006.json"
)
...
def validate() -> dict[str, Any]:
    ...
    if instrument.get("successor_after") != predecessor.INSTRUMENT_ID:
        raise ValueError("terminal predecessor binding drifted")
    correction = instrument.get("diagnostic_correction", {})
    if correction.get("version") != "privacy-safe-responses-diagnostics-v1":
        raise ValueError("provider diagnostic contract drifted")
    if correction.get("evaluated_method_changed") is not False:
        raise ValueError("provider diagnostics changed the evaluated method")

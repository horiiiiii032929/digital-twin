...
Registered by `research/05_evaluation/instruments/product_evidence_gate_selection_003.json`,
...
INSTRUMENT_ID = "product-evidence-gate-selection-003"
INSTRUMENT_PATH = (
    ROOT / "research/05_evaluation/instruments/product_evidence_gate_selection_003.json"
)
...
ARMS: dict[str, dict[str, Any]] = {
    "incumbent": {
        ...
        "role": "what the product ships; release qualification 003 ran it",
    },
    "candidate": {
        "evidence_gate": winner.PRODUCT_DOMINANCE_SCOPED_GATE,
        "role": "the incumbent with its ambiguity contest scoped to tied leaders",
    },
}

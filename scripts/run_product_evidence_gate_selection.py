...
Registered by `research/05_evaluation/instruments/product_evidence_gate_selection_001.json`,
...
INSTRUMENT_ID = "product-evidence-gate-selection-001"
INSTRUMENT_PATH = (
    ROOT / "research/05_evaluation/instruments/product_evidence_gate_selection_001.json"
)
...
def _sources_path() -> Path:
    ...
    if not path.is_file():
        raise GateSelectionError(f"development source package is missing: {path}")
    return path

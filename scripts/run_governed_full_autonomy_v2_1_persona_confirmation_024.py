#!/usr/bin/env python3
"""Run the sole harness-only successor to persona confirmation 023."""
...
from scripts import build_governed_full_autonomy_v2_1_persona_confirmation_024 as package
...
def validate_attempt() -> dict[str, object]:
    ...
    if instrument["method"]["request_intent_contract"] != (
        ...
        raise ValueError("confirmation 024 request-intent contract drifted")
    return {
        **result,
        ...
        "harness_only_changes": ["cost-ceiling-3-to-5", "clock-day-export"],
    }

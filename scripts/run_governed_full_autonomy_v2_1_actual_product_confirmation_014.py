#!/usr/bin/env python3
"""Run the fresh selected H+E1 actual-product autonomy confirmation 014."""
...
CONTEXT = shared.ActualProductEvaluationContext(
    ...
    canary_case_ids=(
        "release-h-e1-trajectory-001-t0-grounded-control-seed-1",
        "release-h-e1-trajectory-006-t1-v2-reactive-seed-1",
    ),

#!/usr/bin/env python3
"""Run the fresh prospectively corrected H+E1 product confirmation 015."""
...
CONTEXT = shared.ActualProductEvaluationContext(
    ...
    selected_grounding_architecture_id="ambiguity-safe-source-semantic-evidence-atoms-v2",
    runtime_grounding_architecture_id="ambiguity-safe-source-semantic-evidence-atoms-v2",
    grounding_missing_blocker="grounding-successor-011-keep-missing",
    canary_case_ids=(
        "release-final-h-e1-trajectory-001-t0-grounded-control-seed-1",
        "release-final-h-e1-trajectory-006-t1-v2-reactive-seed-1",
    ),

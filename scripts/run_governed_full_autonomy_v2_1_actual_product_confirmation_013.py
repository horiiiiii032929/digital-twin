#!/usr/bin/env python3
"""Run the final release-bound autonomy confirmation 013."""
...
CONTEXT = shared.ActualProductEvaluationContext(
    ...
    canary_case_ids=(
        "release-final-trajectory-001-t0-grounded-control-seed-1",
        "release-final-trajectory-006-t1-v2-reactive-seed-1",
    ),

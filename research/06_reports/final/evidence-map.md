...
| Local operational qualification | [`local-r1-governed-v2-1-release-qualification-002`](../../05_evaluation/local-r1-governed-v2-1-release-qualification-002-results.md) | Keep local release | 25/25 live HTTPS checks, 6/6 restart, 6/6 clean restore, 3/3 T0 rollback, 3/3 V2 restoration, and desktop/390-pixel browser checks passed | Durable public hosting, institutional production readiness, or broad accessibility certification |
...
[`student-tutor-r1-local-candidate-v2.json`](../../05_evaluation/profiles/student-tutor-r1-local-candidate-v2.json),
version `v2.1-grounding-011`, and is explicitly marked `experimental`.
...
Terra is bounded to complex pedagogical planning and cannot own factual source
...
2. Review the [current local profile](../../05_evaluation/profiles/student-tutor-r1-local-candidate-v2.json).
...
5. Finish with the [local release qualification](../../05_evaluation/local-r1-governed-v2-1-release-qualification-002-results.md)
   and its limitations.

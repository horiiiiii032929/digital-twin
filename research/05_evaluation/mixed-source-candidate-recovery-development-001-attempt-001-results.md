# Evaluation result: mixed-source-candidate-recovery-development-001-attempt-001
...
dirty; source hashes unchanged: True. [Machine record](records/mixed-source-candidate-recovery-development-001-attempt-001.json).
The original manifest, summary and any ledgers remain under
`reports/generated/mixed-source-candidate-recovery-development-001-attempt-001/`. No attempt was overwritten.

Harness used a Pydantic copying method on dataclass settings; corrected before app creation.
...
| Wall time | 0.000063s |
| Peak process RSS | 294,305,792 bytes |

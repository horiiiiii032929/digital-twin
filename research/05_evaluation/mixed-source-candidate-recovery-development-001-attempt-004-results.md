# Evaluation result: mixed-source-candidate-recovery-development-001-attempt-004
...
dirty; source hashes unchanged: True. [Machine record](records/mixed-source-candidate-recovery-development-001-attempt-004.json).
The original manifest, summary and any ledgers remain under
`reports/generated/mixed-source-candidate-recovery-development-001-attempt-004/`. No attempt was overwritten.

Actual student API rejected missing approved domain model; runner now creates it through the professor domain API.
...
| Measure | Result |
| --- | ---: |
| Executed / passed assertions | 59 / 58 |
| Distinct assertion labels | 48 |
| Injected / external provider calls | 0 / 0 |
| External provider cost | USD 0 |
| Wall time | 1.444333s |
| Peak process RSS | 277,757,952 bytes |

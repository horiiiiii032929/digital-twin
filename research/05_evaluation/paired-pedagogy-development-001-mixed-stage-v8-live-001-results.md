# paired-pedagogy-development-001-mixed-stage-v8-live-001

**The narrow development gates pass; overall improvement is still required.** All 16 independent persistent runtime histories completed 24 student turns across 8 paired synthetic contexts. The experiment compares V4 with V8 under identical fixed student inputs, approved source cards, teaching profiles, Luna model, and 3,000-token output cap. It does not infer semantic success from a returned answer or citation.
